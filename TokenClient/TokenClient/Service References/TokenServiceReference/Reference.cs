...
namespace TokenClient.TokenServiceReference {
    ...
    public interface ITokenService {
        ...
        TokenClient.TokenServiceReference.TokenObject createTokenForUser(int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITokenService/createTokenForUser", ReplyAction="http://tempuri.org/ITokenService/createTokenForUserResponse")]
        System.Threading.Tasks.Task<TokenClient.TokenServiceReference.TokenObject> createTokenForUserAsync(int userId);
        ...
        TokenClient.TokenServiceReference.TokenObject findUserToken(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITokenService/findUserToken", ReplyAction="http://tempuri.org/ITokenService/findUserTokenResponse")]
        System.Threading.Tasks.Task<TokenClient.TokenServiceReference.TokenObject> findUserTokenAsync(string token);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITokenServiceChannel : TokenClient.TokenServiceReference.ITokenService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TokenServiceClient : System.ServiceModel.ClientBase<TokenClient.TokenServiceReference.ITokenService>, TokenClient.TokenServiceReference.ITokenService {
        ...
        public TokenClient.TokenServiceReference.TokenObject createTokenForUser(int userId) {
            return base.Channel.createTokenForUser(userId);
        }
        
        public System.Threading.Tasks.Task<TokenClient.TokenServiceReference.TokenObject> createTokenForUserAsync(int userId) {
            return base.Channel.createTokenForUserAsync(userId);
        }
        
        public TokenClient.TokenServiceReference.TokenObject findUserToken(string token) {
            return base.Channel.findUserToken(token);
        }
        
        public System.Threading.Tasks.Task<TokenClient.TokenServiceReference.TokenObject> findUserTokenAsync(string token) {
